...
<div id="inner_content-19-225" class="ct-inner-content">
    <section id="section-2-6066"
      class=" ct-section ct-section-with-shape-divider">
        <div class="ct-section-inner-wrap">
            <h1 id="headline-3-6066" class="ct-headline">Our Company</h1>
    ...
    <section id="section-5-6066" class=" ct-section">
        <div class="ct-section-inner-wrap">
            <h2 id="headline-6-6066" class="ct-headline">Reputable Home Buyers
            </h2>
            <div id="text_block-13-6066"
              class="ct-text-block atomic-subheading"><b>Sell My House Fast is a
                    team of honest, fair, and <i>fast</i> home buyers!</b></div>
            <div id="div_block-1594-106" class="ct-div-block"></div>
            <div id="new_columns-16-6066" class="ct-new-columns">
                <div id="div_block-17-6066" class="ct-div-block">
                    <p id="text_block-20-6066"
                      class="ct-text-block atomic-content-4-text"><b>We are more
                            than just another “We buy houses” company…</b> Sell
                        My House Fast is known for our honest and fair offers
                        and connecting you to a local cash buyer
                        <i>exclusive</i> to your market!</p>
                    <p id="text_block-95-6066"
                      class="ct-text-block atomic-content-4-text">This means you
                        get access to a reputable and qualified local investor
                        by just filling out our form! As the homeowner, you get
                        to choose whether our offer serves you and your
                        situation best.</p>
                    <p id="text_block-96-6066"
                      class="ct-text-block atomic-content-4-text"><b>We take
                            pride in our business</b> and make sure to reflect
                        that not only through our website but with every
                        interaction we have with homeowners.</p>
                </div>
                <div id="div_block-18-6066" class="ct-div-block"><img
                      id="image-22-6066" alt="our company sell my house fast"
                      src="{{asset('assets/images/logo.webp')}}"
                      class="ct-image"
                      sizes="(max-width: 1380px) 100vw, 1380px"></div>
            </div>
            <div id="div_block-1594-106" class="ct-div-block"></div>
            <div id="new_columns-24-6066" class="ct-new-columns">
                <div id="div_block-25-6066" class="ct-div-block">
                    <h2 id="headline-27-6066" class="ct-headline">Our Rehabs...
                    </h2>
                    <div id="div_block-45-6066" class="ct-div-block">
                        <p id="text_block-29-6066"
                          class="ct-text-block atomic-content-4-text"><b>We keep
                                our rehabs simple</b> and work with local
                            contractors to keep the cost of repairs low.<br></p>
                        <p id="text_block-34-6066"
                          class="ct-text-block atomic-content-4-text">
                            <b><i>“What does this mean for the me?“</i></b><br>
                        </p>
                        <p id="text_block-31-6066"
                          class="ct-text-block atomic-content-4-text"><b></b>We
                            can offer you more for your house putting extra
                            money in your pocket. Learn more about our simple <a
                              href="/how-we-buy-houses/">home selling
                                process</a>.</p>
                        <p id="text_block-38-6066"
                          class="ct-text-block atomic-content-4-text"><b><i>“Do
                                    you take a cut?“</i></b><br></p>
                        <p id="text_block-42-6066"
                          class="ct-text-block atomic-content-4-text"><b></b>As
                            a cash home buying company, we have to make a profit
                            on each home in order to stay in business.</p>
                        <p id="text_block-102-6066"
                          class="ct-text-block atomic-content-4-text"><b></b>We
                            simply can’t work for free no matter how much we
                            love what we do everyday.</p>
                        <p id="text_block-103-6066"
                          class="ct-text-block atomic-content-4-text">
                            <b></b><b>We have fun helping homeowners</b> out of
                            less-than-ideal situations and taking on renovation
                            projects, big or small!</p>
                    </div>
                </div>
                <div id="div_block-26-6066" class="ct-div-block"><img
                      loading="lazy" id="image-44-6066"
                      alt="reputable house buyers"
                      src="{{asset('assets/images/house-1.webp')}}"
                      class="ct-image"
                      sizes="(max-width: 1132px) 100vw, 1132px"></div>
            </div>
            <div id="div_block-1594-106" class="ct-div-block"></div>
            <h2 id="headline-53-6066" class="ct-headline">Our Home Buying
                Advantage</h2>
            <div id="div_block-72-6066" class="ct-div-block">
                <div id="text_block-56-6066"
                  class="ct-text-block atomic-content-4-text"><b></b>As home
                    buyers, we are happy to make you an offer for your property.
                    If you are feeling stuck in your home, or don’t have energy
                    to make repairs, or refuse to work with an agent, or face
                    financial struggles, or any other situation, <b>we may just
                        be the best solution for you…</b></div>
                <div id="div_block-58-6066" class="ct-div-block"><img
                      loading="lazy" id="image-59-6066" alt="how it works"
                      src="//www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check.png"
                      class="ct-image"
                      srcset="//www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check.png 512w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check-300x300.png 300w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check-150x150.png 150w"
                      sizes="(max-width: 512px) 100vw, 512px">
                    <div id="text_block-60-6066"
                      class="ct-text-block atomic-content-4-text"><b></b>We make
                        <i>honest</i> and <i>fair</i> cash offers to provide you
                        with a hassle free home sale.<b></b></div>
                </div>
                <div id="div_block-63-6066" class="ct-div-block"><img
                      loading="lazy" id="image-64-6066" alt="how it works"
                      src="//www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check.png"
                      class="ct-image"
                      srcset="//www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check.png 512w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check-300x300.png 300w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/how-it-works-check-150x150.png 150w"
                      sizes="(max-width: 512px) 100vw, 512px">
                    <div id="text_block-65-6066"
                      class="ct-text-block atomic-content-4-text"><b></b>We
                        always remain flexible around <i>your</i>
                        schedule.<b></b></div>
                </div>
                <div id="text_block-68-6066"
                  class="ct-text-block atomic-content-4-text"><b></b><i>You are
                        not just a number with us– we are problem solvers who
                        want to help you reach your goals with this home
                        sale!</i><b></b></div>
            </div>
            <div id="shortcode-77-6066" class="ct-shortcode">
                ...
                <div class="gf_browser_unknown gform_wrapper gravity-theme"
                  id="gform_wrapper_1">
                    ...
                    <form method="post" enctype="multipart/form-data"
                      ...
                      action="/our-company/#gf_1" novalidate=""><input
            ...
            <div id="div_block-1594-106" class="ct-div-block"></div>
            <h2 id="headline-81-6066" class="ct-headline">Your Trusted Cash Home
                Buyers!</h2>
            <div id="text_block-110-6066"
              class="ct-text-block atomic-content-4-text"><b></b><i>Sell My
                    House Fast values honesty, integrity and transparency. We
                    eliminate all of the drawbacks that come with selling your
                    house the traditional way. We do not rely on lender
                    financing– we have our own cash. We buy properties as-is and
                    close on your timeline. Unlike realtors, we do not charge
                    commission or fees. If you need to sell your house for cash,
                    we truly believe we could be a great option!</i><b></b>
            </div>
            <div id="div_block-1594-106" class="ct-div-block"></div>
            <div id="div_block-87-6066" class="ct-div-block">
