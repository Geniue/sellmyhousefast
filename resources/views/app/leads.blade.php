...
<div id="inner_content-19-225" class="ct-inner-content">
                ...
                <div class="gf_browser_gecko gform_wrapper gravity-theme"
                  id="gform_wrapper_8">
                    ...
                    <form method="post" enctype="multipart/form-data"
                      target="gform_ajax_frame_8" id="gform_8"
                      action="/leads/#gf_8" novalidate="">
                        <div class="gform_body gform-body">
                            <div id="gform_fields_8"
                              class="gform_fields top_label form_sublabel_below description_below">
                                <fieldset id="field_8_1"
                                  class="gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible"
                                  data-js-reload="field_8_1">
                                    <legend
                                    ...
                                    <div
                                      ...
                                      id="input_8_1">
                                        <span id="input_8_1_3_container"
                                          class="name_first">
                                            <input type="text" name="input_1.3"
                                              id="input_8_1_3" value=""
                                              aria-required="true">
                                            <label
                                              for="input_8_1_3">First</label>
                                        </span>
                                        <span id="input_8_1_6_container"
                                          class="name_last">
                                            <input type="text" name="input_1.6"
                                              id="input_8_1_6" value=""
                                              aria-required="true">
                                            <label
                                              for="input_8_1_6">Last</label>
                                        </span>
                                    </div>
                                </fieldset>
                                <div id="field_8_3"
                                  ...
                                  data-js-reload="field_8_3"><label
                                      class="gfield_label"
                                      for="input_8_3">Phone<span
                                ...
                                <div id="field_8_4"
                                  class="gfield gfield--width-half gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible"
                                  data-js-reload="field_8_4"><label
                                      class="gfield_label"
                                      for="input_8_4">Email<span
                                          class="gfield_required"><span
                                              class="gfield_required gfield_required_asterisk">*</span></span></label>
                                    <div
                                      class="ginput_container ginput_container_email">
                                        <input name="input_4" id="input_8_4"
                        ...
                        <div class="gform_footer top_label"> <input type="image"
                              src="//www.sellmyhousefast.com/wp-content/uploads/2023/02/step-2-leads-form.webp"
                            ...
                            <input type="hidden" name="gform_ajax"
                              value="form_id=8&amp;title=&amp;description=&amp;tabindex=0">
                            <input type="hidden" class="gform_hidden"
                              name="is_submit_8" value="1">
                            <input type="hidden" class="gform_hidden"
                              name="gform_submit" value="8">
                            <input type="hidden" class="gform_hidden"
        ...
        <div class="ct-section-inner-wrap">
            ...
            <div id="div_block-359-106" class="ct-div-block ">
                ...
                <div id="div_block-1669-106" class="ct-div-block"><img
                      ...
                      src="{{asset('assets/images/motivated-real-estate-investor-leads-2048x1302.webp')}}"
                      class="ct-image"
                      sizes="(max-width: 2520px) 100vw, 2520px">
                    <div id="text_block-1673-6212" class="ct-text-block">Access
                        leads in the <a>hottest
    ...
    <section id="section-1596-106" class=" ct-section">
        <div class="ct-section-inner-wrap">
            <div id="div_block-1671-6212" class="ct-div-block">
                <div id="shortcode-1600-106" class="ct-shortcode">
                    <div class="gf_browser_gecko gform_wrapper gravity-theme"
                      id="gform_wrapper_9">
                        ...
                        <form method="post" enctype="multipart/form-data"
                          target="gform_ajax_frame_9" id="gform_9"
                          action="/leads/#gf_9" novalidate="">
                            <div class="gform_body gform-body">
                                <div id="gform_fields_9"
                                  class="gform_fields top_label form_sublabel_below description_below">
                                    <fieldset id="field_9_1"
                                      class="gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible"
                                      data-js-reload="field_9_1">
                                        ...
                                        <div
                                          class="ginput_complex ginput_container no_prefix has_first_name no_middle_name has_last_name no_suffix gf_name_has_2 ginput_container_name"
                                          id="input_9_1">
                                            <span id="input_9_1_3_container"
                                              class="name_first">
                                                <input type="text"
                                                  name="input_1.3"
                                                  id="input_9_1_3" value=""
                                                  aria-required="true">
                                                <label
                                                  for="input_9_1_3">First</label>
                                            </span>
                                            <span id="input_9_1_6_container"
                                              class="name_last">
                                                <input type="text"
                                                  name="input_1.6"
                                                  id="input_9_1_6" value=""
                                                  aria-required="true">
                                                <label
                                                  for="input_9_1_6">Last</label>
                                            </span>
                                        </div>
                                    </fieldset>
                                    <div id="field_9_3"
                                    ...
                                    <div id="field_9_4"
                                      class="gfield gfield--width-half gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible"
                                      data-js-reload="field_9_4"><label
                                          class="gfield_label"
                                          for="input_9_4">Email<span
                                              class="gfield_required"><span
                                                  class="gfield_required gfield_required_asterisk">*</span></span></label>
                                        <div
                                          class="ginput_container ginput_container_email">
                                            <input name="input_4" id="input_9_4"
                                              type="email" value=""
                            ...
                            <div class="gform_footer top_label"> <input
                                ...
                                <input type="hidden" class="gform_hidden"
                                  name="is_submit_9" value="1">
                                <input type="hidden" class="gform_hidden"
                                  name="gform_submit" value="9">
                                <input type="hidden" class="gform_hidden"
                                  name="gform_unique_id" value="">
                                <input type="hidden" class="gform_hidden"
                                  name="state_9"
                                ...
                                <input type="hidden" class="gform_hidden"
                                  ...
                                  id="gform_target_page_number_9" value="0">
                                <input type="hidden" class="gform_hidden"
                                  name="gform_source_page_number_9"
                                  id="gform_source_page_number_9" value="1">
                                <input type="hidden" name="gform_field_values"
                                  value="">
                            </div>
                        </form>
