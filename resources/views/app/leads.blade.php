...
#section-2-224 {
    background-image: linear-gradient(rgba(100,100,100,0.3),rgba(100,100,100,0.3)),url(//www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-hero.webp);
    text-align: center;
...
@section('content')
<div id="inner_content-19-225" class="ct-inner-content"><section id="section-2-224" class=" ct-section ct-section-with-shape-divider"><div class="ct-section-inner-wrap"><h2 id="headline-4-224" class="ct-headline atomic-primary-heading">Real Estate Investor Leads</h2><div id="div_block-1194-106" class="ct-div-block"><img id="image-1676-6122" alt="sell my house fast" src="//www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast.webp" class="ct-image" srcset="//www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast.webp 386w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-300x300.webp 300w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-150x150.webp 150w" sizes="(max-width: 386px) 100vw, 386px"><p id="text_block-1626-106" class="ct-text-block atomic-content-26-text"></p><div style="text-align: center;"><span style="font-size: 1.25rem;"><b>Are you an <i>active</i> real estate investor who buys houses for cash? Not just a wholesaler? Apply to gain access to our SEO <i>leads</i> in your markets!</b></span></div><p></p></div><div id="shortcode-678-106" class="ct-shortcode"><script type="text/javascript"></script>
    <div class="gf_browser_gecko gform_wrapper gravity-theme" id="gform_wrapper_8"><div id="gf_8" class="gform_anchor" tabindex="-1"></div>
    <div class="gform_heading">
    <p class="gform_required_legend"></p>
    </div><form method="post" enctype="multipart/form-data" target="gform_ajax_frame_8" id="gform_8" action="/leads/#gf_8" novalidate="">
    <div class="gform_body gform-body"><div id="gform_fields_8" class="gform_fields top_label form_sublabel_below description_below"><fieldset id="field_8_1" class="gfield gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_8_1"><legend class="gfield_label gfield_label_before_complex">Name<span class="gfield_required"><span class="gfield_required gfield_required_asterisk">*</span></span></legend><div class="ginput_complex ginput_container no_prefix has_first_name no_middle_name has_last_name no_suffix gf_name_has_2 ginput_container_name" id="input_8_1">
    ...
    </div></fieldset><div id="field_8_3" class="gfield gfield--width-half gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_8_3"><label class="gfield_label" for="input_8_3">Phone<span class="gfield_required"><span class="gfield_required gfield_required_asterisk">*</span></span></label><div class="ginput_container ginput_container_phone"><div class="iti iti--allow-dropdown iti--separate-dial-code"><div class="iti__flag-container"><div class="iti__selected-flag" role="combobox" aria-controls="iti-0__country-listbox" aria-owns="iti-0__country-listbox" aria-expanded="false" tabindex="0" title="United States: +1" aria-activedescendant="iti-0__item-us-preferred"><div class="iti__flag iti__us"></div><div class="iti__selected-dial-code">+1</div><div class="iti__arrow"></div></div><ul class="iti__country-list iti__hide" id="iti-0__country-listbox" role="listbox" aria-label="List of countries"><li class="iti__country iti__preferred iti__active" tabindex="-1" id="iti-0__item-us-preferred" role="option" data-dial-code="1" data-country-code="us" aria-selected="true"><div class="iti__flag-box"><div class="iti__flag iti__us"></div></div><span class="iti__country-name">United States</span><span class="iti__dial-code">+1</span></li><li class="iti__divider" role="separator" aria-disabled="true"></li><li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-ca" role="option" data-dial-code="1" data-country-code="ca" aria-selected="false"><div class="iti__flag-box"><div class="iti__flag iti__ca"></div></div><span class="iti__country-name">Canada</span><span class="iti__dial-code">+1</span></li><li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-us" role="option" data-dial-code="1" data-country-code="us" aria-selected="false"><div class="iti__flag-box"><div class="iti__flag iti__us"></div></div><span class="iti__country-name">United States</span><span class="iti__dial-code">+1</span></li></ul></div><input name="" id="input_8_3_raw" type="tel" value="" class="large" placeholder="###-###-####" aria-required="true" aria-invalid="false" autocomplete="off" data-intl-tel-input-id="0" style="padding-left: 73px;"><input type="hidden" name="input_3" id="input_8_3"></div></div></div><div id="field_8_4" class="gfield gfield--width-half gfield_contains_required field_sublabel_below field_description_below gfield_visibility_visible" data-js-reload="field_8_4"><label class="gfield_label" for="input_8_4">Email<span class="gfield_required"><span class="gfield_required gfield_required_asterisk">*</span></span></label><div class="ginput_container ginput_container_email">
    <input name="input_4" id="input_8_4" type="email" value="" class="large" aria-required="true" aria-invalid="false">
    </div></div></div></div>
    <div class="gform_footer top_label"> <input type="image" src="//www.sellmyhousefast.com/wp-content/uploads/2023/02/step-2-leads-form.webp" id="gform_submit_button_8" class="gform_button button gform-button--width-full gform_image_button" alt="Submit" onclick="if(window[&quot;gf_submitting_8&quot;]){return false;}  if( !jQuery(&quot;#gform_8&quot;)[0].checkValidity || jQuery(&quot;#gform_8&quot;)[0].checkValidity()){window[&quot;gf_submitting_8&quot;]=true;}  " onkeypress="if( event.keyCode == 13 ){ if(window[&quot;gf_submitting_8&quot;]){return false;} if( !jQuery(&quot;#gform_8&quot;)[0].checkValidity || jQuery(&quot;#gform_8&quot;)[0].checkValidity()){window[&quot;gf_submitting_8&quot;]=true;}  jQuery(&quot;#gform_8&quot;).trigger(&quot;submit&quot;,[true]); }"> <input type="hidden" name="gform_ajax" value="form_id=8&amp;title=&amp;description=&amp;tabindex=0">
    <input type="hidden" class="gform_hidden" name="is_submit_8" value="1">
    <input type="hidden" class="gform_hidden" name="gform_submit" value="8">
    <input type="hidden" class="gform_hidden" name="gform_unique_id" value="">
    <input type="hidden" class="gform_hidden" name="state_8" value="WyJbXSIsImMzYmI3MTczODkwYjAxYmU4MGUyOWUyZjE4YmQ1YTFkIl0=">
    ...
    </div></section><section id="section-353-106" class=" ct-section"><div class="ct-section-inner-wrap"><h1 id="headline-354-106" class="ct-headline atomic-secondary-heading"><b>Highly Motivated REI Leads</b></h1><p id="text_block-1616-106" class="ct-text-block atomic-content-26-text"><b>Join Our Ethical Network Of Investors For Access To Highly Motivated Leads!</b></p><div id="div_block-1594-106" class="ct-div-block"></div><div id="div_block-359-106" class="ct-div-block "><p id="text_block-361-106" class="ct-text-block atomic-content-26-text">We are looking for real estate investors who buy houses anywhere in the United States including Puerto Rico to join our investor network for access to highly motivated SEO leads. We bring in leads from sellers who are searching for a specific solution to their problem, and <b>we want to give investors across the nation access to these high quality leads</b>.<br></p><div id="div_block-1669-106" class="ct-div-block"><img loading="lazy" id="image-1670-106" alt="motivated real estate investor leads" src="//www.sellmyhousefast.com/wp-content/uploads/2023/02/motivated-real-estate-investor-leads.webp" class="ct-image" srcset="//www.sellmyhousefast.com/wp-content/uploads/2023/02/motivated-real-estate-investor-leads.webp 2520w, //www.sellmyhousefast.com/wp-content/uploads/2023/02/motivated-real-estate-investor-leads-300x191.webp 300w, //www.sellmyhousefast.com/wp-content/uploads/2023/02/motivated-real-estate-investor-leads-1024x651.webp 1024w, //www.sellmyhousefast.com/wp-content/uploads/2023/02/motivated-real-estate-investor-leads-768x488.webp 768w, //www.sellmyhousefast.com/wp-content/uploads/2023/02/motivated-real-estate-investor-leads-1536x976.webp 1536w, //www.sellmyhousefast.com/wp-content/uploads/2023/02/motivated-real-estate-investor-leads-2048x1302.webp 2048w" sizes="(max-width: 2520px) 100vw, 2520px"><div id="text_block-1673-6212" class="ct-text-block">Access leads in the <a href="https://sparkrental.com/hottest-real-estate-markets/">hottest markets</a>&nbsp;across the country!</div></div><p id="text_block-1203-106" class="ct-text-block atomic-content-26-text">We only work with <b>ethical real estate investors</b> who prioritize the sellers' best interests. If you are an ethical and honest investor who wants to work with homeowners that need help selling, apply by filling out the short form below. Once we confirm you are qualified, we will give you access to our highly motivated SEO leads in your market(s)!<b></b></p></div></div></section><section id="section-1596-106" class=" ct-section"><div class="ct-section-inner-wrap"><div id="div_block-1671-6212" class="ct-div-block"><div id="shortcode-1600-106" class="ct-shortcode">
    <div class="gf_browser_gecko gform_wrapper gravity-theme" id="gform_wrapper_9"><div id="gf_9" class="gform_anchor" tabindex="-1"></div>
    <div class="gform_heading">
    <p class="gform_required_legend"></p>
    </div><form method="post" enctype="multipart/form-data" target="gform_ajax_frame_9" id="gform_9" action="/leads/#gf_9" novalidate="">
