...
#section-219-25 > .ct-section-inner-wrap {
    padding-top: 120px;
...
#section-97-232 > .ct-section-inner-wrap {
    max-width: 100%;
    padding-top: 30px;
    padding-bottom: 69px;
    display: flex;
...
#section-230-25 > .ct-section-inner-wrap {
    padding-top: 53px;
    padding-bottom: 52px;
    display: flex;
    flex-direction: column;
...
#section-230-25 {
    background-image: linear-gradient(#ff6851,#ff6851);
    text-align: center;
    background-position: 0% 50%
}

#section-144-25 > .ct-section-inner-wrap {
    padding-top: 63px;
    padding-bottom: 120px;
    display: flex;
    flex-direction: column;
...
@media (max-width: 991px) {
    #new_columns-262-25> .ct-div-block {
        width:100% !important
    }
}

@media (max-width: 991px) {
    #new_columns-278-25> .ct-div-block {
        width:100% !important
    }
}
...
#-shape-divider-331-25 .oxy_shape_divider {
    color: #ffffff;
    z-index: 0
}

#-shape-divider-331-25 .oxy_shape_divider svg {
    height: 70px
}
...
@section('content')
<div id="inner_content-19-225" class="ct-inner-content"><section id="section-219-25" class=" ct-section ct-section-with-shape-divider"><div class="ct-section-inner-wrap"><h1 id="headline-220-25" class="ct-headline atomic-primary-heading">We Are Andy &amp; Liz...</h1><h3 id="headline-256-25" class="ct-headline"><span style="font-weight: normal;">Come Get To Know Us!</span></h3><p id="text_block-329-25" class="ct-text-block atomic-subheading">As engineers, we’ve always had a passion for problem solving. But, we really found our niche once we combined our passion with real estate…<br></p>
    <div id="-shape-divider-331-25" class="oxy-shape-divider ">
    <div class="oxy_shape_divider">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none"><path fill="currentColor" fill-opacity="1" d="M0,288L1440,0L1440,320L0,320Z"></path></svg> </div>
    </div>
    </div></section><section id="section-97-232" class=" ct-section"><div class="ct-section-inner-wrap"><h2 id="headline-98-232" class="ct-headline atomic-secondary-heading">Meet the Two of Us!</h2><div id="new_columns-262-25" class="ct-new-columns"><div id="div_block-263-25" class="ct-div-block"><img loading="lazy" id="image-313-25" alt="about us" src="//www.sellmyhousefast.com/wp-content/uploads/2022/11/about-us.webp" class="ct-image" srcset="//www.sellmyhousefast.com/wp-content/uploads/2022/11/about-us.webp 1024w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/about-us-300x225.webp 300w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/about-us-768x577.webp 768w" sizes="(max-width: 1024px) 100vw, 1024px"></div><div id="div_block-264-25" class="ct-div-block"><h3 id="headline-265-25" class="ct-headline">Andy Kolodgie &amp; Liz Hutz</h3><p id="text_block-319-25" class="ct-text-block atomic-subheading"><span style="font-weight: normal;">Cash Home Buyers, SEO Experts, &amp; Engineers</span><br></p><p id="text_block-322-25" class="ct-text-block atomic-subheading"><b>Andy and Liz are Virginia Tech grads</b> who went from coding software for Navy ships and aircrafts to flipping houses. As co-owners of <a href="/our-company/">Sell My House Fast</a>, we have years of experience buying, renovating, and selling homes in multiple markets across the country.<br></p><div id="div_block-320-25" class="ct-div-block"><img loading="lazy" id="image-321-25" alt="about us sell my house fast" src="//www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast.webp" class="ct-image" srcset="//www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast.webp 386w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-300x300.webp 300w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-150x150.webp 150w" sizes="(max-width: 386px) 100vw, 386px"><p id="text_block-272-25" class="ct-text-block atomic-subheading">We keep busy through all of our different roles, but our #1 priority is you, the homeowner!<span style="font-weight: normal;"> Without happy customers, we wouldn’t be able to maintain our top position nationwide.</span><br></p></div><p id="text_block-327-25" class="ct-text-block atomic-subheading">When we’re not busy flipping houses, you can catch us on the next flight to pretty much anywhere! We also love hanging out at local breweries, hiking, and trail running.<br></p></div></div></div></section><section id="section-230-25" class=" ct-section"><div class="ct-section-inner-wrap"><h2 id="headline-231-25" class="ct-headline atomic-secondary-heading"><b>Why Choose Us?</b></h2><p id="text_block-234-25" class="ct-text-block atomic-subheading">What you see is what you get with us. We don’t dress in button downs or slacks. We’re not going for that pseudo-perfect image. <b>We are honest, fair, and reliable people who work hard.</b> We want to help each and every homeowner including you!</p></div></section><section id="section-144-25" class=" ct-section"><div class="ct-section-inner-wrap"><h2 id="headline-242-25" class="ct-headline atomic-secondary-heading">Our Promise To You</h2><div id="new_columns-278-25" class="ct-new-columns"><div id="div_block-279-25" class="ct-div-block"><p id="text_block-276-25" class="ct-text-block atomic-subheading"><b>We commit to being fair, honest, and respectful with <i>every</i> interaction.</b> We will act with integrity and <i>never</i> take advantage of a difficult situation. We will have a positive attitude and always do whatever it takes to arrive at a win-win for everyone.<br></p><p id="text_block-333-25" class="ct-text-block atomic-subheading"><b></b>We believe a person dealing with a difficult situation needs someone who can help. We promise to be there for you as we do our absolute best to truly be the solution to your real estate troubles.<br></p></div><div id="div_block-280-25" class="ct-div-block"><img loading="lazy" id="image-282-25" alt="about sell my house fast" src="//www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-brand.webp" class="ct-image" srcset="//www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-brand.webp 1380w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-brand-300x300.webp 300w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-brand-1024x1024.webp 1024w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-brand-150x150.webp 150w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/sell-my-house-fast-brand-768x768.webp 768w" sizes="(max-width: 1380px) 100vw, 1380px"></div></div><p id="text_block-293-25" class="ct-text-block atomic-subheading"><i style="">Our goal is to help every homeowner, including you. You will be treated with respect &amp; integrity the entire way.</i><br></p><div id="div_block-290-25" class="ct-div-block"><img loading="lazy" id="image-291-25" alt="andy kolodgie and liz hutz" src="//www.sellmyhousefast.com/wp-content/uploads/2022/11/andy-liz-signatures.webp" class="ct-image" srcset="//www.sellmyhousefast.com/wp-content/uploads/2022/11/andy-liz-signatures.webp 998w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/andy-liz-signatures-300x128.webp 300w, //www.sellmyhousefast.com/wp-content/uploads/2022/11/andy-liz-signatures-768x327.webp 768w" sizes="(max-width: 998px) 100vw, 998px"></div></div></section></div>
@endsection