...
@section('content')
<div id="inner_content-19-225" class="ct-inner-content"><section id="section-55-24" class=" ct-section ct-section-with-shape-divider"><div class="ct-section-inner-wrap"><h1 id="headline-56-24" class="ct-headline atomic-primary-heading">Connect With Us!</h1>
    <div id="-shape-divider-125-24" class="oxy-shape-divider ">
    <div class="oxy_shape_divider">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none"><path fill="currentColor" fill-opacity="1" d="M0,288L1440,0L1440,320L0,320Z"></path></svg> </div>
    </div>
    </div></section><section id="section-2-233" class=" ct-section"><div class="ct-section-inner-wrap"><div id="div_block-86-24" class="ct-div-block"><h2 id="headline-78-24" class="ct-headline">Have some questions you want to ask us?</h2><div id="new_columns-110-24" class="ct-new-columns"><div id="div_block-111-24" class="ct-div-block"><div id="div_block-95-24" class="ct-div-block"><p id="text_block-94-24" class="ct-text-block atomic-content-4-text">Excellent! We love talking with people to see how we can <b>help you reach your goals</b>. We recognize many people are skeptical. There are scammers and dishonest companies, so we understand the importance of credibility.<br></p><p id="text_block-134-24" class="ct-text-block atomic-content-4-text">If you have questions about:</p><ul id="div_block-98-24" class="ct-div-block"><li id="text_block-101-24" class="ct-text-block atomic-content-4-text">The history of <a href="/our-company/">our company</a> and who we are.</li><li id="text_block-103-24" class="ct-text-block atomic-content-4-text"><a href="/how-we-buy-houses/">How we buy houses</a><a href="/how-it-works/">&nbsp;</a>and make you a fair all cash offer for your house.</li><li id="text_block-105-24" class="ct-text-block atomic-content-4-text">Our process for helping homeowners avoid foreclosure.</li><li id="text_block-106-24" class="ct-text-block atomic-content-4-text">Or anything else you want to ask us, even if it’s just to make sure we’re real people!</li></ul></div></div><div id="div_block-112-24" class="ct-div-block"><img id="image-114-24" alt="contact us sell my house fast" src="//www.sellmyhousefast.com/wp-content/uploads/2023/02/andy-kolodgie-author.webp" class="ct-image" srcset="//www.sellmyhousefast.com/wp-content/uploads/2023/02/andy-kolodgie-author.webp 512w, //www.sellmyhousefast.com/wp-content/uploads/2023/02/andy-kolodgie-author-300x300.webp 300w, //www.sellmyhousefast.com/wp-content/uploads/2023/02/andy-kolodgie-author-150x150.webp 150w" sizes="(max-width: 512px) 100vw, 512px"></div></div><p id="text_block-116-24" class="ct-text-block atomic-content-4-text"><b>Just give us a call</b> at the phone number below or shoot us an email through the form. We’ll get back to you within 24 hours. If you need us quicker, make sure to call or text us, as we’re able to answer phone calls more quickly than we’re able to return emails.<br></p><p id="text_block-128-24" class="ct-text-block atomic-content-4-text">We look forward to chatting with you!</p><p id="text_block-129-24" class="ct-text-block atomic-content-4-text"><i>Don’t forget to check out our <a href="/faq/">frequently asked questions</a> to see if any of your questions have been answered.</i> 🙂</p></div><div id="div_block-1594-106" class="ct-div-block"></div></div></section><section id="section-82-24" class=" ct-section"><div class="ct-section-inner-wrap"><h2 id="headline-83-24" class="ct-headline">Contact Info</h2><div id="text_block-124-24" class="ct-text-block atomic-content-4-text"><b></b>Sell My House Fast<br>4510 Tipton Ln<br>Alexandria, VA 22310<br><a href="tel:844-207-0788">(844) 207-0788</a><br><a href="mailto:team@sellmyhousefast.com">team@sellmyhousefast.com</a></div><div id="shortcode-65-24" class="ct-shortcode"><script type="text/javascript"></script>
    <div class="gf_browser_chrome gform_wrapper gravity-theme" id="gform_wrapper_1"><div id="gf_1" class="gform_anchor" tabindex="-1"></div>
    <div class="gform_heading">
    <p class="gform_required_legend"></p>
    </div><div class="partial_entry_warning" style="margin-bottom: 10px;">.</div><form method="post" enctype="multipart/form-data" target="gform_ajax_frame_1" id="gform_1" action="/contact-us/#gf_1" novalidate=""><input id="partial_entry_id_1" class="partial_entry_id" type="hidden" name="partial_entry_id" value="pending" data-form_id="1">
